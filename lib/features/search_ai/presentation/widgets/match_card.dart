        ...
        children: [
          ...
          if (match.reasons.isNotEmpty) ...[
            Wrap(
              spacing: 8,
              runSpacing: 4,
              children: match.reasons.map((r) => _Chip(label: r.label)).toList(),
            ),
          ...
          Wrap(
            ...
            children: [
              ...
              if (p?.isVerified == true)
                _Chip(label: t('profiles.badge.verified'), accent: AppColors.secondary),
              if (p?.isVip == true)
                _Chip(label: t('profiles.badge.vip'), accent: AppColors.gold),
